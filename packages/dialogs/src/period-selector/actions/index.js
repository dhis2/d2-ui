...
export const toggleOfferedPeriod = (period, index, isShiftPressed = false, isCtrlPressed = false) => ({
...
export const toggleSelectedPeriod = (period, index, isShiftPressed = false, isCtrlPressed = false) => ({
