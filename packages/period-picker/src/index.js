...
class PeriodPicker extends PureComponent {
    ...
    onPeriodFieldChange = ({ target }) => {
        ...
        const periodType = periodTypeMap.get(futureState.periodType);
    ...
    async fetchPeriodTypes() {
        try {
            ...
            periodTypes = response.periodTypes.reduce((acc, { name }) => {
                const supportedPeriod = periodTypeMap.get(name);
                if (supportedPeriod) {
        ...
        return (
            <Fragment>
                ...
                {this.state.periodType && (
                    <PeriodFields
                        periodFields={periodTypeMap
                            .get(this.state.periodType)
                            .getPeriodFields()}
