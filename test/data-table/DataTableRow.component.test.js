...
describe('DataTableRow component', () => {
    ...
    beforeEach(() => {
        ...
        dataTableRow = TestUtils.renderIntoDocument(
            <DataTableRow dataSource={dataElement} columns={['name', 'code']} />
        );
    });
    ...
    it('should render two columns', () => {
        expect(TestUtils.scryRenderedDOMComponentsWithClass(dataTableRow, 'data-table__rows__row__column').length).to.equal(2);
    });
